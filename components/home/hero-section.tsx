  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="bg-primary/10 absolute -top-40 -right-40 h-80 w-80 animate-pulse rounded-full blur-[120px]" />
        <div className="bg-secondary/10 absolute -bottom-40 -left-40 h-80 w-80 animate-pulse rounded-full blur-[120px] delay-1000" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            ...
            <p className="text-text-secondary mx-auto max-w-3xl text-xl md:text-2xl">
              The elite checkout platform that transforms payment transactions into
              <span className="text-primary font-semibold"> visually stunning</span>, highly
          ...
          <motion.div
            variants={containerVariants}
            className="grid w-full max-w-6xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4"
          >
            {features.map((feature) => (
              <motion.div key={feature.title} variants={itemVariants}>
                <GlassmorphicCard className="group h-full p-6 text-left" hover>
                  <div
                    className={`inline-flex rounded-xl bg-gradient-to-br p-3 ${feature.gradient} mb-4 transition-transform group-hover:scale-110`}
                  >
          ...
          <motion.div variants={itemVariants} className="mt-16">
            <p className="text-text-tertiary text-sm">
              Trusted by over{' '}
              <span className="text-text-secondary font-semibold">1,000+ entrepreneurs</span> to
              power their checkout experience
            </p>
          </motion.div>
        </motion.div>
      </div>
