        ...
        <div className="overflow-hidden">
          <table className="w-full">
            <thead className="border-b border-gray-200">
              <tr>
                <th className="text-left p-6 font-medium text-gray-700">Code</th>
                <th className="text-left p-6 font-medium text-gray-700">Terms</th>
                <th className="text-left p-6 font-medium text-gray-700">Redemptions</th>
                <th className="text-left p-6 font-medium text-gray-700">Status</th>
                <th className="text-left p-6 font-medium text-gray-700">Created</th>
                <th className="p-6"></th>
              </tr>
            </thead>
            <tbody>
                  ...
                  >
                    <td className="p-6">
                      <div className="flex items-center gap-2">
                        <code className="px-3 py-1 bg-gray-100 rounded-lg font-mono font-semibold">
                          {coupon.code}
                        </code>
                        <button
