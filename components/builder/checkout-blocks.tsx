                  ...
                  <div className="space-y-3">
                    <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                      <div className="text-center">
                        <p className="text-sm font-medium text-gray-700 mb-1">Express Checkout</p>
                        ...
                        <div className="mt-3 flex flex-wrap justify-center gap-2 text-xs">
                          ...
                          <span className="px-2 py-1 bg-blue-500 text-white rounded">Google Pay</span>
                          <span className="px-2 py-1 bg-orange-500 text-white rounded">Amazon Pay</span>
                          <span className="px-2 py-1 bg-purple-500 text-white rounded">Link</span>
                        </div>
                      </div>
                    </div>
                  </div>
