  ...
  useEffect(() => {
    ...
    const updateMetrics = () => {
      setPerformanceData((prev) => {
        ...
        const newRenderTime = Math.max(
          20,
          prev.metrics.renderTime.value + (Math.random() - 0.5) * 10
        )
        ...
        return {
          metrics: {
            ...
            renderTime: {
              ...
              value: newRenderTime,
              score:
                newRenderTime < 100 ? 'good' : newRenderTime < 200 ? 'needs-improvement' : 'poor',
            },
          },
          history: [
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <motion.button
              ...
              className={cn(
                'fixed right-6 bottom-6 z-50 flex items-center gap-2 rounded-full px-4 py-2 shadow-lg backdrop-blur-sm transition-all',
                overallScore >= 80
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 z-50 h-full w-96 overflow-hidden bg-white shadow-2xl"
          >
            {/* Header */}
            ...
            {/* Overall Score */}
            <div className="border-b bg-gradient-to-br from-gray-50 to-white p-6">
