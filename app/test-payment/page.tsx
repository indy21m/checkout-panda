    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-white mb-2">Test Stripe Payment</h1>
          <p className="text-gray-300">This is a test page to demonstrate Stripe integration</p>
        </div>

        <Card variant="glass" className="max-w-2xl mx-auto p-6 mb-8">
          <h2 className="text-xl font-semibold text-white mb-4">Test Details</h2>
          <div className="space-y-2 text-gray-300">
            <p><strong>Checkout ID:</strong> {testCheckoutId}</p>
            <p><strong>Product ID:</strong> {testProductId}</p>
            <p><strong>Amount:</strong> ${(testAmount / 100).toFixed(2)}</p>
          </div>
