      ...
      <div className="container mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="prose prose-lg text-text-secondary max-w-none space-y-6">
          ...
          <section className="space-y-4">
            <h2 className="text-text mt-8 text-2xl font-semibold">1. Information We Collect</h2>
            <p className="leading-relaxed">
              We collect information you provide directly to us, such as when you create an account,
              use our services, make a purchase, or contact us for support.
            </p>
            <p className="leading-relaxed">The types of information we may collect include:</p>
          ...
          <section className="space-y-4">
            <h2 className="text-text mt-8 text-2xl font-semibold">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                In response to a request for information if we believe disclosure is required by
                applicable law, regulation, or legal process
              </li>
              <li>
                To protect the rights, property, and safety of Checkout Panda, our users, or others
              </li>
          ...
          <section className="space-y-4">
            <h2 className="text-text mt-8 text-2xl font-semibold">4. Data Security</h2>
            <p className="leading-relaxed">
              We take reasonable measures to help protect information about you from loss, theft,
              misuse, unauthorized access, disclosure, alteration, and destruction. We implement
              appropriate technical and organizational measures to ensure a level of security
              appropriate to the risk.
            </p>
            <p className="leading-relaxed">
              However, no Internet or electronic communication is ever fully secure or error-free.
              Please take special care in deciding what information you send to us.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-text mt-8 text-2xl font-semibold">5. Data Retention</h2>
            <p className="leading-relaxed">
              ...
              accounting, or reporting requirements, or to resolve disputes and enforce our
              agreements.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-text mt-8 text-2xl font-semibold">6. Your Rights and Choices</h2>
            <p className="leading-relaxed">
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                <strong>Portability:</strong> You can request a copy of your personal information in
          ...
          <section className="space-y-4">
            <h2 className="text-text mt-8 text-2xl font-semibold">9. Children&apos;s Privacy</h2>
            <p className="leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-text mt-8 text-2xl font-semibold">11. Contact Us</h2>
            <p className="leading-relaxed">
