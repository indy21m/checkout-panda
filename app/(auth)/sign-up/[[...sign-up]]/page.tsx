  ...
  return (
    <AuthLayout>
      <div className="rounded-xl bg-white p-8 shadow-xl">
        <h2 className="mb-2 text-center text-2xl font-bold">Create an account</h2>
        <p className="text-text-secondary mb-6 text-center">Get started with Checkout Panda</p>
        ...
        <p className="text-text-secondary mt-6 text-center text-sm">
          ...
          <Link href="/sign-in" className="text-emerald-500 hover:text-emerald-600">
            Sign in
          </Link>
        </p>
      </div>
